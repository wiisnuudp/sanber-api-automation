...
describe("endpoint - categories", async ()=> {
    //create category
...
describe("endpoint - customers", async ()=> {
...
describe("endpoint - product", async ()=> {
